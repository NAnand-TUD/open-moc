...
# Added by Jozef to toggle plotting optionc
if (imprtplt==False):
	print("Matplot lib was not found. Exiting.. ")
if (PlotResults and imprtplt): plt.savefig(DIR+File_Name_Plot,format=pltFrmt,dpi=1000)
##
## END
##---------------------------------------------------------------------------------------------#
